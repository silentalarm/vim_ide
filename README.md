...
Как только установите Плагины зайдите в папку репозитории моей сборки и используйте эту команду в терминале:
...
Теперь на 5 строчке в .zshrc

       vim ~/.rc

 ник поменяйте на свой ник
